...
|---|---|---|---|---|---|---|
| R1 | Auth migration issues (token reuse, clock, Keychain) | M | H | Auth tests, Field Test | Rotation + family revoke; 15m access | 1 |
| R2 | Web regression from shared service edits | M | H | `npm test`, Playwright live **after** Field Test | Additive v1; no cookie rewrite | 1–5 |
...
| R10 | Production data safety (apps hitting prod, cron spoof) | M | H | flavor review; B18 | Dev bundle ≠ prod host; CRON_SECRET | 1 |
