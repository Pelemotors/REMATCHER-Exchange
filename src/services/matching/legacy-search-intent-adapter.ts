...
const VEHICLE_IDENTITY_ALIASES: Record<string, string> = {
  ...
  "טויוטה": "Toyota", "יונדאי": "Hyundai", "קיה": "Kia", "מאזדה": "Mazda", "מיצובישי": "Mitsubishi",
  "ניסאן": "Nissan", "ניסן": "Nissan", "רנו": "Renault", "פיג'ו": "Peugeot", "פיגו": "Peugeot", "סיאט": "Seat",
  "סוזוקי": "Suzuki", "אאודי": "Audi", "ב.מ.וו": "BMW", "במוו": "BMW", "מרצדס": "Mercedes-Benz", "סובארו": "Subaru",
  "הונדה": "Honda", "פורד": "Ford", "שברולט": "Chevrolet", "סיטרואן": "Citroen", "אופל": "Opel", "וולוו": "Volvo",
  "לקסוס": "Lexus", "ג'יפ": "Jeep", "ג׳יפ": "Jeep", "דאצ'יה": "Dacia", "דאציה": "Dacia", "טסלה": "Tesla",
  "ג'ילי": "Geely", "ג׳ילי": "Geely", "צ'רי": "Chery", "צ׳רי": "Chery", "בי.וואי.די": "BYD", "ביואידי": "BYD",
  "סופרב": "Superb", "אוקטביה": "Octavia", "קודיאק": "Kodiaq", "קארוק": "Karoq", "טוסון": "Tucson",
  "ספורטאז'": "Sportage", "ספורטז'": "Sportage", "ספורטאז׳": "Sportage", "קשקאי": "Qashqai", "אקסטרייל": "X-Trail",
  "אאוטלנדר": "Outlander", "קורולה": "Corolla", "יאריס": "Yaris", "סוויפט": "Swift", "ויטרה": "Vitara",
  "גולף": "Golf", "טיגואן": "Tiguan", "לאון": "Leon", "ארונה": "Arona", "אטקה": "Ateca", "מגאן": "Megane",
  "קפצ'ור": "Captur", "קפצ׳ור": "Captur",
};
...
export function legacyToSearchIntent(
  ...
  if (confirmed.yearMin != null || confirmed.yearMax != null) {
    intent.year = {
      importance: "HARD", target: confirmed.yearMin ?? confirmed.yearMax ?? null,
      flexibility: { hardMin: confirmed.yearMin ?? null, hardMax: confirmed.yearMax ?? null, comfortableMin: confirmed.yearMin ?? null, comfortableMax: confirmed.yearMax ?? null },
      provenance: "legacy_adapter", confidence: 0.85,
    };
  }
  if (confirmed.budgetMax != null) {
    const hardMax = Math.round(confirmed.budgetMax * 1.1);
    intent.price = {
      importance: "HIGH", target: confirmed.budgetMax,
      flexibility: { target: confirmed.budgetMax, comfortableMax: confirmed.budgetMax, stretchMax: hardMax, hardMax },
      provenance: "legacy_adapter", confidence: 0.8, notes: "Legacy soft +10% budget rule mapped into stretch/hardMax",
    };
  }
