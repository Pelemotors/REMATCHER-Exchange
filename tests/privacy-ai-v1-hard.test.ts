...
describe("Architecture wiring present", () => {
  it("privacy routes and pages exist", () => {
    const files = [
      ...
      "src/app/api/privacy/account-deletion/route.ts",
      "src/app/api/v1/privacy/status/route.ts",
      "src/app/api/v1/privacy/consents/route.ts",
      "src/app/api/v1/privacy/account-deletion/route.ts",
      "src/app/api/v1/privacy/onboarding/complete/route.ts",
